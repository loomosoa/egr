...
Когда на схемке показано, что множества s и к будут одним множеством.
...
Сразу целиком в итоговую идею того, что делает выражение, или же по этапам, отразив визуально ключевые концепты?
